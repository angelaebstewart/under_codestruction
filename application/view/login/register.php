<div class="container">
    ...
    <div class="login-box" style="width: 50%; display: block;">
        ...
        <!-- register form -->
        <form method="post" action="<?php echo Config::get('URL','gen'); ?>login/register_action">
            ...
            <a href="#" style="display: block; font-size: 11px; margin: 5px 0 15px 0; text-align: center"
               onclick="document.getElementById('captcha').src = '<?php echo Config::get('URL','gen'); ?>login/showCaptcha?' + Math.random(); return false">Reload Captcha</a>
