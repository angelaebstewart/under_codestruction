        ...
        <div>
            <table class="overview-table">
                ...
                <?php foreach ($this->users as $user) { ?>
                    <tr class="<?php echo  ($user->user_active == 0 ? 'inactive' : 'active'); ?>">
                        <td><?php echo $user->user_id; ?></td>
                        <td class="avatar">
                            <?php if (isset($user->user_avatar_link)) { ?>
                                <img src="<?php echo  $user->user_avatar_link; ?>" />
                            <?php } ?>
                        </td>
                        <td><?php echo $user->user_name; ?></td>
                        <td><?php echo  $user->user_email; ?></td>
                        <td><?php echo  ($user->user_active == 0 ? 'No' : 'Yes'); ?></td>
                        <td>
                            <a href="<?php echo Config::get('URL') . 'profile/showProfile/' . $user->user_id; ?>">Profile</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
